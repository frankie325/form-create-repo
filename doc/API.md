- [API](#api)
  ...
  - [验证操作](#验证操作)
    ...
    - [clearValidateState](#clearvalidatestate)
    - [clearSubValidateState](#clearsubvalidatestate)
...
### validate
表单校验，与iview一致，参考[iview表单校验](https://iviewui.com/components/form#API)
```js 
fApi.validate()
```
### updateValidate
...
*/ 
fApi.submit((formData,api)=>{}, (formData,api)=>{})
```